...
import { Button, Form, TextArea, TextInput, Tile } from 'carbon-components-react';
    ...
    return (
      <div className="bx--grid">
        ...
        <Form>
          ...
          <DecodedTransaction
            signedAmount={this.state.signedAmount}
            signedAsset={this.state.signedAsset}
            signedRecipient={this.state.signedRecipient}
            signedAssetDecimals={this.state.signedAssetDecimals}
            signedAssetName={this.state.signedAssetName}
          />
          <div className="bx--row row-padding">
            <TextInput
              className="bx--col-xs-6"
